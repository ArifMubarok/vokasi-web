...
class FasilitasController extends Controller
{
    ...
    private function getDataObject(){
        return Detail_prodi::where('prodi_id', $this->prodiId())->where('name', 'fasilitas')->first();
    }

    public function index()
    {
        return view('back.pages.admin.pages.fasilitas.index', [
    ...
    {
        return view('back.pages.admin.pages.fasilitas.create-edit');
    }
    ...
    public function store(Request $request)
    {
        ...
        if (!(Detail_prodi::where('prodi_id', $prodi_id)->where('name', 'fasilitas')->first())) {
            Detail_prodi::create([
                'prodi_id' => $prodi_id,
                'name' => 'fasilitas',
                'value' => ''
        ...
        $data = Detail_prodi::where('prodi_id', $prodi_id)->where('name', 'fasilitas')->first();
        ...
        return redirect(route('admin.pages.fasilitas.index'))->with('success', 'Success saving data!');
    }
    ...
    public function destroy($id)
    {
        ...
        $data = Detail_prodi::findOrFail($id);
        $data->delete();
        return redirect(route('admin.pages.fasilitas.index'))->with('delete', 'Success delete data!');
    }
}
