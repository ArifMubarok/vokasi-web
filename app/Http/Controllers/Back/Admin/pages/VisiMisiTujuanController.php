...
class VisiMisiTujuanController extends Controller
{
    ...
    private function getDataObject(){
        return Detail_prodi::where('prodi_id', $this->prodiId())->where('name', 'visi-misi-tujuan')->first();
    }

    public function index()
    {
        return view('back.pages.admin.pages.visi-misi-tujuan.index', [
    ...
    {
        return view('back.pages.admin.pages.visi-misi-tujuan.create-edit');
    }
    ...
    public function store(Request $request)
    {
        ...
        if (!(Detail_prodi::where('prodi_id', $prodi_id)->where('name', 'visi-misi-tujuan')->first())) {
            Detail_prodi::create([
                'prodi_id' => $prodi_id,
        ...
        $data = Detail_prodi::where('prodi_id', $prodi_id)->where('name', 'visi-misi-tujuan')->first();
        ...
        return redirect(route('admin.pages.visi-misi-tujuan.index'))->with('success', 'Success saving data!');
    }
    ...
    public function destroy($id)
    {
        ...
        $data = Detail_prodi::findOrFail($id);
        $data->delete();
        return redirect(route('admin.pages.visi-misi-tujuan.index'))->with('delete', 'Success delete data!');
    }
}
