...
class ProfilLulusanController extends Controller
{
    ...
    private function getDataObject(){
        return Detail_prodi::where('prodi_id', $this->prodiId())->where('name', 'profil-lulusan')->first();
    }

    public function index()
    {
        return view('back.pages.admin.pages.profil-lulusan.index', [
    ...
    {
        return view('back.pages.admin.pages.profil-lulusan.create-edit');
    }
    ...
    public function store(Request $request)
    {
        ...
        if (!(Detail_prodi::where('prodi_id', $prodi_id)->where('name', 'profil-lulusan')->first())) {
            Detail_prodi::create([
                'prodi_id' => $prodi_id,
                'name' => 'profil-lulusan',
                'value' => ''
        ...
        $data = Detail_prodi::where('prodi_id', $prodi_id)->where('name', 'profil-lulusan')->first();
        ...
        return redirect(route('admin.pages.profil-lulusan.index'))->with('success', 'Success saving data!');
    }
    ...
    public function destroy($id)
    {
        ...
        $data = Detail_prodi::findOrFail($id);
        $data->delete();
        return redirect(route('admin.pages.profil-lulusan.index'))->with('delete', 'Success delete data!');
    }
}
