...
class KerjasamaController extends Controller
{
    ...
    private function getDataObject(){
        return Detail_prodi::where('prodi_id', $this->prodiId())->where('name', 'kerjasama')->first();
    }

    public function index()
    {
        return view('back.pages.admin.pages.kerjasama.index', [
    ...
    {
        return view('back.pages.admin.pages.kerjasama.create-edit');
    }
    ...
    public function store(Request $request)
    {
        ...
        if (!(Detail_prodi::where('prodi_id', $prodi_id)->where('name', 'kerjasama')->first())) {
            Detail_prodi::create([
                'prodi_id' => $prodi_id,
                'name' => 'kerjasama',
                'value' => ''
        ...
        $data = Detail_prodi::where('prodi_id', $prodi_id)->where('name', 'kerjasama')->first();
        ...
        return redirect(route('admin.pages.kerjasama.index'))->with('success', 'Success saving data!');
    }
    ...
    public function destroy($id)
    {
        ...
        $data = Detail_prodi::findOrFail($id);
        $data->delete();
        return redirect(route('admin.pages.kerjasama.index'))->with('delete', 'Success delete data!');
    }
}
