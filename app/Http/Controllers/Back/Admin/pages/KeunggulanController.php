...
class KeunggulanController extends Controller
{
    ...
    private function getDataObject(){
        return Detail_prodi::where('prodi_id', $this->prodiId())->where('name', 'keunggulan')->first();
    }

    public function index()
    {
        return view('back.pages.admin.pages.keunggulan.index', [
    ...
    {
        return view('back.pages.admin.pages.keunggulan.create-edit');
    }
    ...
    public function store(Request $request)
    {
        ...
        if (!(Detail_prodi::where('prodi_id', $prodi_id)->where('name', 'keunggulan')->first())) {
            Detail_prodi::create([
                'prodi_id' => $prodi_id,
                'name' => 'keunggulan',
                'value' => ''
        ...
        $data = Detail_prodi::where('prodi_id', $prodi_id)->where('name', 'keunggulan')->first();
        ...
        return redirect(route('admin.pages.keunggulan.index'))->with('success', 'Success saving data!');
    }
    ...
    public function destroy($id)
    {
        ...
        $data = Detail_prodi::findOrFail($id);
        $data->delete();
        return redirect(route('admin.pages.keunggulan.index'))->with('delete', 'Success delete data!');
    }
}
