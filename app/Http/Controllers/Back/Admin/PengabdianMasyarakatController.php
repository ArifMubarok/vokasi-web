...
class PengabdianMasyarakatController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('back.pages.admin.berita.index');
    }
        ...
        if ($request->ajax()) {
            ...
            return DataTables::of($data)
                ...
                ->addColumn('action', function ($row) {
                    ...
                    if ($row->isValidate == 0) {
                        $btn = $btn . '<a href="' . route('admin.pengabdian-masyarakat.edit', $row->id) . '" class="btn btn-dark buttons-edit"><i class="fas fa-edit"></i></a>';
                    }
                    $btn = $btn . '<a href="' . route('admin.pengabdian-masyarakat.show', $row->id) . '" class="btn btn-info buttons-edit"><i class="fas fa-eye"></i></a>';
    ...
    public function show($id)
    {
        ...
        return view('back.pages.admin.berita.show', [
            'data' => $data,
        ]);
    }
    ...
    {
        $kategori = Kategori::where('name', 'Pengabdian')->pluck('id')->toArray();
        return view('back.pages.admin.berita.create-edit', [
            'kategoris' => $kategori,
        ]);
    }
    ...
    public function store(Request $request)
    {
        ...
        return redirect(route('admin.pengabdian-masyarakat.index'))->with('success', 'Success saving data!');
    }
