    ...
    */
    ...
    'configs' => [
        ...
        'default' => [
            ...
            'HTML.Allowed' => 'h1,h2,h3,h4,h5,h6,b,strong,i,em,s,del,a[href|title],ul,ol,li,p[style],br,span,img[width|height|alt|src|data-filename|style],img[style],span[style],div[style],h1[style],h2[style],h3[style],h4[style],h5[style],h6[style],iframe[src]',
