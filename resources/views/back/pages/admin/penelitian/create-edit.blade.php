          ...
          <div class="col-md-11 mt-4 mx-auto">
            <div class="card card-primary">
              ...
              <div class="card-body" style="display: block;">
                <form action="{{ isset($data) ? route('admin.penelitian-dosen.update', $data->id) : route('admin.penelitian-dosen.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @if(isset($data))
                    {{ method_field('PUT') }}
                    @endif
                    ...
                    <div class="form-group">
                        ...
                        <div class="select2-purple">
                            <select id="kategori" class="select2" name="kategori_id[]" data-placeholder="Select a State" multiple="multiple" data-dropdown-css-class="select2-purple" style="width: 100%;" required>
                              <option value="{{ $kategoris[0] }}">Penelitian Dosen</option>
                            </select>
                          </div>
                    </div>
                    <div class="form-group">
