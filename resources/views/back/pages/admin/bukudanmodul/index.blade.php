                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a
                                href="{{ route('admin.bukudanmodul.index') }}">@yield('title')</a>
                        </li>
                    </ol>
                </div>
            </div>
        ...
        <div class="container-fluid">
            <div class="row justify-content-end">
                <div class="col-2 my-3">
                    <a href="{{ route('admin.bukudanmodul.create') }}"
        ...
        <script type="text/javascript">
            $(function() {
                ...
                var table = $('.dosen-datatable').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('admin.bukudanmodul.list') }}",
                    columns: [{
                            data: 'DT_RowIndex',
                            name: 'DT_RowIndex'
                        },
                ...
                $(document).on('click', '.hapus', function() {
                    if (window.confirm('Are you sure?')) {
                        let id = $(this).attr('id')
                        $.ajax({
                            url: "{{ route('admin.bukudanmodul.hapus') }}",
                            type: 'post',
                            data: {
                                id: id,
                                "_token": "{{ csrf_token() }}"
