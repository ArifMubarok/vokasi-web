                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a
                                href="{{ route('admin.pages.kerjasama.index') }}">@yield('title')</a></li>
                    </ol>
                </div>
            </div>
        </div>
                ...
                <div class="col-12">
                    @if (isset($data))
                        <div class="row justify-content-end mb-3">
                            <div class="col-1">
                                <a href="{{ route('admin.pages.kerjasama.edit', $data->id) }}"
                                    class="btn btn-block btn-info btn-sm">Edit</a>
                            </div>
                            <div class="col-1">
                                <form action="{{ route('admin.pages.kerjasama.destroy', $data->id) }}" method="post" onsubmit="return confirm('Anda yakin ingin menghapus data?');">
                                  @csrf
                                    <button type="submit" href="{{ route('admin.pages.kerjasama.destroy', $data->id) }}" 
                        ...
                        <div class="card">
                            <div class="card-body">
                                <div class="row mx-auto">
                                    <div class="my-3">
                                        <a href="{{ route('admin.pages.kerjasama.create') }}"
