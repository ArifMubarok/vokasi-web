                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a
                                href="{{ route('admin.produk-unggulan.index') }}">@yield('title')</a>
                        </li>
                    </ol>
                </div>
            </div>
        ...
        <div class="container-fluid">
            <div class="row justify-content-end">
                <div class="col-2 my-3">
                    <a href="{{ route('admin.produk-unggulan.create') }}"
                    ...
                    <div class="card card-outline card-primary">
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mx-auto">
                                <div class="col">
                                    <table class="table table-bordered produk-datatable">
                                        <thead>
                                            <tr>
    ...
    @push('js')
        ...
        <script type="text/javascript">
            $(function() {
                ...
                var table = $('.produk-datatable').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('admin.produk-unggulan.list') }}",
                    columns: [{
                            data: 'DT_RowIndex',
                            name: 'DT_RowIndex'
                        },
                ...
                $(document).on('click', '.hapus', function() {
                    if (window.confirm('Are you sure?')) {
                        let id = $(this).attr('id')
                        $.ajax({
                            url: "{{ route('admin.produk-unggulan.hapus') }}",
                            type: 'post',
                            data: {
                                id: id,
                                "_token": "{{ csrf_token() }}"
                            ...
                            success: function(params) {
                                alert(params.text)
                                $('.produk-datatable').DataTable().ajax.reload()
                            }
                        })
                    }
                })
