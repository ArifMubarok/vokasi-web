                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a
                                href="{{ route('humas.manajemen-berita.berita.index') }}">@yield('title')</a></li>
                    </ol>
                </div>
            </div>
        </div>
                        ...
                        <div class="card-body">
                            <div class="row mx-auto">
                                <div class="col-3 my-3">
                                    <a href="{{ route('humas.manajemen-berita.berita.create') }}"
        ...
        <script type="text/javascript">
            $(function() {
                ...
                var table = $('.berita-datatable').DataTable({
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('humas.manajemen-berita.berita.list') }}",
                    columns: [{
                            data: 'DT_RowIndex',
                            name: 'DT_RowIndex'
                        },
                ...
                $(document).on('click', '.hapus', function() {
                    let id = $(this).attr('id')
                    $.ajax({
                        url: "{{ route('humas.manajemen-berita.berita.hapus') }}",
                        type: 'post',
                        data: {
                            id: id,
                            "_token": "{{ csrf_token() }}"
