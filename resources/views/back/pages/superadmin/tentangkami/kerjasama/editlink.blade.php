          ...
          <div class="col-md-11 mt-4 mx-auto">
            <div class="card card-primary">
              ...
              <div class="card-body" style="display: block;">
                <form action="{{ route('superadmin.tentangkami.kerjasama.updateData',$data->id) }}" method="POST">
                    @csrf
                    {{ method_field('PUT') }}
                    <div class="form-group">
                      <label for="value">Profile Singkat</label><br>
                      <input class="form-control" name="value" id="value" required value="{{ $data->value }}">
                    </div>
