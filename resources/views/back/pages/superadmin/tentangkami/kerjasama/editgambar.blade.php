...
@section('title', 'Gambar Kerjasama')
          ...
          <div class="col-md-11 mt-4 mx-auto">
            <div class="card card-primary">
              ...
              <div class="card-body" style="display: block;">
                <form action="{{ route('superadmin.tentangkami.kerjasama.updateData',$data->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    {{ method_field('PUT') }}
                    <div class="form-group">
                      <label for="value" class="form-label">Foto Header</label>
                      @if (isset($data))
                          <p><img src="{{ asset('storage/images/kerjasama/' . $data->value) }}" alt="" style="width: 20%"></p>
                      @endif
