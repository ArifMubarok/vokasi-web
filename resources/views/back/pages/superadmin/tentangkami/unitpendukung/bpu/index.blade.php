                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a
                                href="{{ route('superadmin.tentangkami.unit-pendukung.BPU.index') }}">@yield('title')</a>
                        </li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card card-outline card-primary">
                        <div class="card-header">
                            <h3 class="card-title">{{ Str::ucfirst('Pengenalan BPU') }}</h3>
                        ...
                        <div class="card-body ">
                            ...
                            <div class="row mt-4 justify-content-end">
                                <div class="col-1 ml-3">
                                    @if ($isibpu == null)
                                        <a href="{{ route('superadmin.tentangkami.unit-pendukung.BPU.create') }}"
                                            class="btn btn-block btn-success btn-sm">Tambah
                                        </a>
                                    @else
                                        <a href="{{ route('superadmin.tentangkami.unit-pendukung.BPU.edit') }}"
