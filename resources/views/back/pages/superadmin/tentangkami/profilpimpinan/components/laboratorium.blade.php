...
@section('title', 'List Kepala Laboratorium')
                ...
                <div class="col-12">
                    <div class="card card-outline card-primary">
                        <div class="card-header">
                            <h3 class="card-title">Kepala Laboratorium</h3>
        ...
        <script type="text/javascript">
            $(function() {
                ...
                var table = $('.laboratorium-datatable').DataTable({
                    ...
                    processing: true,
                    serverSide: true,
                    ajax: "{{ route('superadmin.tentangkami.profil-pimpinan.laboratorium.listLaboratorium') }}",
                    columns: [{
                            data: 'DT_RowIndex',
                            name: 'DT_RowIndex'
                        },
