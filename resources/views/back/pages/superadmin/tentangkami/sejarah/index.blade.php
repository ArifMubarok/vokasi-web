            ...
            <div class="row mb-2">
                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a href="{{ route('superadmin.tentangkami.sejarah.index') }}">@yield('title')</a>
                        </li>
                    </ol>
                </div>
            </div>
                ...
                <div class="col-12">
                    <div class="card card-outline card-primary">
                        <div class="card-header">
                            <h3 class="card-title">{{ Str::ucfirst($data->pages_name)  }}</h3>
                        ...
                        <div class="card-body">
                            ...
                            <div class="row mt-4">
                                <div class="col-1 ml-3"><a
                                        href="{{ route('superadmin.tentangkami.sejarah.edit', $data->konten->id) }}"
