                ...
                <div class="col-sm-6">
                    <ol class="breadcrumb float-sm-right">
                        ...
                        <li class="breadcrumb-item"><a
                                href="{{ route('superadmin.mahasiswa.bem.index') }}">@yield('title')</a>
                        </li>
                    </ol>
                </div>
            </div>
                                ...
                                <div class="row">
                                    <div class="col mx-3">
                                        @switch($item->konten->name)
                                            ...
                                            @case('foto-bem')
                                                <p><img src="{{ asset('storage/images/mahasiswa/bem/' . $item->konten->value) }}"
                                    ...
                                    @switch($item->konten->name)
                                        @case('isi-bem')
                                            <div class="col-1 ml-3">
                                                <a href="
                                                    {{ route('superadmin.mahasiswa.bem.edit', $item->konten->id) }}
                                                    "
                                        ...
                                        @case('foto-bem')
                                            <div class="col-1 ml-3">
                                                <a href="
                                                    {{ route('superadmin.mahasiswa.bem.editpicture', $item->konten->id) }}
                                                    "
                                                    class="btn btn-block btn-info btn-sm">Edit</a>
                                            </div>
                                        @break
