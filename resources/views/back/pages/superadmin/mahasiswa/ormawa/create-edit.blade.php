          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="{{ route('superadmin.mahasiswa.ormawa.index') }}">@yield('title')</a></li>
              </ol>
            </div>
          </div>
        </div>
          ...
          <div class="col-md-11 mt-4 mx-auto">
            <div class="card card-primary">
              ...
              <div class="card-body" style="display: block;">
                <form action="{{ isset($data) ? route('superadmin.mahasiswa.ormawa.update', $data->id) : route('superadmin.mahasiswa.ormawa.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @if(isset($data))
                    {{ method_field('PUT') }}
                    @endif
                    ...
                    <div class="form-group">
                        ...
                        @if (isset($data->logo))
                          ...
                          <p><img src="{{ asset('storage/mahasiswa/ormawa/logo/'.$data->logo) }}" alt="" style="width: 20%"></p>
                        @endif
