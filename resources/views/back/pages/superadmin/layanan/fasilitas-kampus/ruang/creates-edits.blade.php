          ...
          <div class="col-md-11 mt-4 mx-auto">
            <div class="card card-primary">
              ...
              <div class="card-body" style="display: block;">
                <form action="{{ isset($data) ? route('superadmin.layanan.fasilitas-kampus.ruang.proses.updates', $data->id) : route('superadmin.layanan.fasilitas-kampus.ruang.proses.stores') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @if(isset($data))
                    {{ method_field('PUT') }}
                    @endif
