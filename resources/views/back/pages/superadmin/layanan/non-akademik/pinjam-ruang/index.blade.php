                ...
                <div class="col-12">
                    <div class="card card-outline card-primary">
                        <div class="card-header">
                            <h3 class="card-title">
                                {{ Str::ucfirst($pinjam_ruang[0]->pages_name) }}
                            </h3>
                        ...
                        <div class="card-body ">
                            @foreach ($pinjam_ruang as $item)
                                <div class="row">
                                    <div class="col mx-3">
                                        @if (isset($item->konten->value))
                                            <img src="{{ asset('storage/images/pinjam-ruang/' . $item->konten->value) }}" alt="pinjam-ruang" width="100%">
                                        @endif
                                    </div>
                                </div>
                                <div class="row mt-4">
                                    <div class="col-1 mx-3">
                                        <a href="{{ route('superadmin.layanan.non-akademik.pinjam-ruang.editPinjamRuang', $item->konten->id) }}" class="btn btn-block btn-info btn-sm">Edit</a>
                                    </div>
                                </div>
                            @endforeach
                        </div>
