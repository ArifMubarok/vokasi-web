          ...
          <div class="row mb-2">
            ...
            <div class="col-sm-6">
              <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="{{ route('superadmin.layanan.akademik.buku-pedoman.index') }}">@yield('title')</a></li>
              </ol>
            </div>
          </div>
        </div>
          ...
          <div class="col-md-11 mt-4 mx-auto">
            <div class="card card-primary">
              ...
              <div class="card-body" style="display: block;">
                <form action="{{ isset($data) ? route('superadmin.layanan.akademik.buku-pedoman.update', $data->id) : route('superadmin.layanan.akademik.buku-pedoman.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    @if(isset($data))
                    {{ method_field('PUT') }}
                    @endif
                    ...
                    <div class="form-group">
                        ...
                        @if (isset($data->cover))
                          ...
                          <p><img src="{{ asset('storage/content/buku-pedoman/cover/'.$data->cover) }}" alt="" style="width: 20%"></p>
                        @endif
                    ...
                    @if (isset($data))
                    <div class="form-group">
                      <iframe src="{{ asset('storage/content/buku-pedoman/file/'. $data->file) }}" width="50%" height="600">
                        This browser does not support PDFs. Please download the PDF to view it: <a href="{{ asset('storage/content/buku-pedoman/file/'. $data->file) }}">Download PDF</a>
                      </iframe>
                    </div>
                    @endif
