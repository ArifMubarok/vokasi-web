          ...
          <div class="col-md-11 mt-4 mx-auto">
            <div class="card card-primary">
              ...
              <div class="card-body" style="display: block;">
                <form action="{{ route('superadmin.layanan.akademik.kalender-akademik.update', $data->id) }}" method="POST" enctype="multipart/form-data">
                    @csrf
                    {{ method_field('PUT') }}
                    <div class="form-group">
                      <label for="value" class="form-label">Foto Kalender Akademik</label>
                      @if (isset($data))
                          <p><img src="{{ asset('storage/images/kalender-akademik/' . $data->value) }}" alt="" style="width: 50%"></p>
                      @endif
